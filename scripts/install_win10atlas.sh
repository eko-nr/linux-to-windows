#!/bin/bash
# ============================================================
# Windows 10 Atlas UNATTENDED Installer for Debian 12+ / Ubuntu 22+
# Full automation with reboot handling (FIXED windowsPE parsing)
# ============================================================

VM_NAME=${1:-win10atlas}
...
read -p "Computer name [WIN10-atlas]: " WIN_COMPUTERNAME
WIN_COMPUTERNAME=${WIN_COMPUTERNAME:-WIN10-atlas}
...
ISO_FILE="${ISO_CACHE}/Windows10-atlas.iso"
ISO_LINK="/var/lib/libvirt/boot/Windows10-atlas.iso"
...
if [[ "$INSTALL_COMPLETE" == "true" ]]; then
  ...
  ok "Windows 10 atlas installed successfully!"
  echo ""
